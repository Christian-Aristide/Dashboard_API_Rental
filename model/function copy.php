...
function getArticle($id = null, $searchDATA = array(), $limit = null, $offset = null)
{
    ...
    if (!empty($id)) {
        $sql = "SELECT a.id AS id, a.id_categorie, a.nom_article, c.libelle_categorie, a.quantite, a.prix_unitaire, a.date_fabrication, 
        a.date_expiration, a.images
        FROM article AS a
        INNER JOIN categorie_article AS c ON a.id_categorie = c.id
